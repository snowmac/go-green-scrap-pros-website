...
const JUNK_ITEMS = [
  ...
  'treadmill', 'exercise_bike', 'elliptical', 'weight_bench',
  'grill', 'lawn_mower', 'snow_blower',
  'misc_item'
];
...
const SCRAP_ITEMS = [
  ...
  'catalytic_converter', 'sheet_metal', 'rebar', 'pipe',
  'refrigerator', 'freezer', 'washer', 'dryer', 'dishwasher',
  'stove_oven', 'microwave', 'water_heater', 'ac_unit',
  'misc_metal'
];
